...
<form method="POST" action="<?php echo e(route('storeuser')); ?>" class="w-100 ">
    <?php echo csrf_field(); ?>
...
<?php endif; ?>
                ...
                <div class="form-group col-lg-12">
                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'jetstream::components.label','data' => ['for' => 'email','value' => ''.e(__('Email')).'','class' => 'form-label']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('jet-label'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
...
<?php endif; ?>
            ...
            <button href="<?php echo e(route('storeuser')); ?>" class="btn btn-primary btn-rounded btn-uppercase  w-4"> <?php echo e(__('create user')); ?></button>
...
<?php echo $__env->make('layouts.dashboardlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ayodhya/Desktop/websales/resources/views/sales/create.blade.php ENDPATH**/ ?>