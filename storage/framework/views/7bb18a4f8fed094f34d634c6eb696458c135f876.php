            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="media align-items-center">
                            ...
                            <div class="media-body">
                                <div class="text-high-em text-uppercase"><?php echo e($vendor->User_id); ?> </div> 
                    ...
                    <td>
                        <div class="progress-lb-wrap">
                            <div class="d-flex align-items-center">
                                    ...
                                    <div class="text-high-em"><?php echo e($vendor->Campany_Name); ?> </div>  
                    ...
                    <td>
                        ...
                        <span class="badge badge-soft-secondary my-1  me-2"><?php echo e($vendor->Mobile); ?></span>
                    </td>
                    <td>
                        <div class="d-flex align-items-center">
                            <form action="<?php echo e(route('vendor.edit', $vendor->id)); ?>" method="get">
                                <?php echo csrf_field(); ?>
                            ...
                            <form action="<?php echo e(route('vendor.destroy', ['vendor'=> $vendor->id])); ?>" method="post">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.dashboardlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ayodhya/Desktop/websales/resources/views/Vendors/viewVendor.blade.php ENDPATH**/ ?>