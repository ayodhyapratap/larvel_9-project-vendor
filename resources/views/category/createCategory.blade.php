    ...
    <div class="col-xxl-10 col-xl-10 col-lg-10 mx-auto mt-20 ">
        ...
        <div class="row gx-3">
            ...
            <div class="form-group col-lg-12">
                ...
                <x-jet-input id="email" class="form-control" type="text" name="Category_Name" value=" "  required />
            ...
            <div class="form-group col-lg-12">
                <x-jet-label for="password_confirmation" value="{{ __('Discription') }}" class="form-label" />
    
                <div class="input-group password-check">
                    <span class="input-affix-wrapper affix-wth-text">
                        {{-- <input class="form-control" placeholder="6+ characters" value="" type="password"> --}}
                        <x-jet-input id="password_confirmation" class="form-control" type="text" name="discriptions"   required  />
            ...
            <div class="form-group col-lg-12">
                ...
                <x-jet-input id="price" class="form-control" type="text" name="Category_Value"   required />
            ...
            {{-- <div class="form-group col-lg-6">
                ...
                <x-jet-input id="email" class="form-control" type="text" name="Mobile"  required />
