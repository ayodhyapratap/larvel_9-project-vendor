            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="media align-items-center">
                            ...
                            <div class="media-body">
                                <div class="text-high-em text-uppercase">{{$category->Category_Name}} </div> 
                    ...
                    <td>
                        <div class="progress-lb-wrap">
                            <div class="d-flex align-items-center">
                                    ...
                                    <div class="text-high-em">{{$category->discriptions}} </div>  
                    ...
                    <td>
                        ...
                        <span class="badge badge-soft-secondary my-1  me-2">{{$category->Category_Value}}</span>
                    </td>
                    <td>
                        <div class="d-flex align-items-center">
