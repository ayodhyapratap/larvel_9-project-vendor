    ...
    <div class="col-xxl-10 col-xl-10 col-lg-10 mx-auto mt-20">
        ...
        <div class="row gx-3">
            ...
            <div class="form-group col-lg-12">
                ...
                <x-jet-input id="email" class="form-control" type="text" name="Campany_Name" value=" "  required />
            ...
            <div class="form-group col-lg-12">
                ...
                <div class="input-group password-check">
                    <span class="input-affix-wrapper affix-wth-text">
                        ...
                        <x-jet-input id="password_confirmation" class="form-control" type="text" name="Address"   required  />
            ...
            <div class="form-group col-lg-12">
                ...
                <x-jet-input id="price" class="form-control" type="text" name="GST_NO"   required />
