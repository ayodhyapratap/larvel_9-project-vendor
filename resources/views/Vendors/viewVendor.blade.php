        ...
        <table id="datable_1" class="table nowrap w-100 mb-5">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="media align-items-center">
                            ...
                            <div class="media-body">
                                <div class="text-high-em text-uppercase">{{$vendor->User_id}} </div> 
                    ...
                    <td>
                        <div class="progress-lb-wrap">
                            <div class="d-flex align-items-center">
                                    ...
                                    <div class="text-high-em">{{$vendor->Campany_Name}} </div>  
                    ...
                    <td>
                        {{-- <span class="badge badge-soft-secondary  my-1  me-2"> {{$vendor->price}}</span> --}}
                        <span class="badge badge-soft-secondary my-1  me-2">{{$vendor->Mobile}}</span>
                    </td>
                    <td>
                        <div class="d-flex align-items-center">
                            <form action="{{ route('vendor.edit', $vendor->id) }}" method="get">
                                @csrf
