                        ...
                        <ul id="dash_chat" class="nav flex-column collapse  nav-children">
                            <li class="nav-item">
                                <ul class="nav flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{route('createUser')}}"><span class="nav-link-text">Create Salesperson</span></a>
                                    </li>
                                </ul>	
                            </li>	
                        </ul>	
                        ...
                        <ul id="dash_chatpop" class="nav flex-column collapse  nav-children">
                            <li class="nav-item">
                                <ul class="nav flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ route('product.index') }}"><span class="nav-link-text">Update Products</span></a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ route('product.create') }}"><span class="nav-link-text">Create Products</span></a>
                                    </li>
                                    <li class="nav-item">
                        ...
                        <ul id="dash_scrumboard" class="nav flex-column collapse  nav-children">
                            <li class="nav-item">
                                <ul class="nav flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ route('vendor.index') }} "><span class="nav-link-text">Update Venders</span></a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ route('vendor.create') }}"><span class="nav-link-text">Create Venders</span></a>
                                    </li>
                                </ul>	
                            </li>	
                        </ul>	
